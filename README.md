...
[![tests: 197](https://img.shields.io/badge/tests-197-brightgreen?style=flat)](test/)
![lints: 19](https://img.shields.io/badge/lints-19-blue?style=flat)
...
This README is generated from `README.tsx` with [KnickKnackLabs/readme](https://github.com/KnickKnackLabs/readme). The repository currently asks codebase `0.4` to run **19** convention lints.
